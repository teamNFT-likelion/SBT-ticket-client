...
export function payCardByTossPayment(_price, _name, _customer, _dataId, _inactiveId) {
...
export function payTransferByTossPayment(_price, _name, _customer, _dataId, _inactiveId) {
  loadTossPayments(clientKey).then((tossPayments) => {
    tossPayments
      .requestPayment('계좌이체', {
        amount: _price,
